...
import { DocumentListTable } from '../../src/components/DocumentListTable';
...
export default function DocumentsScreen() {
  ...
  const someSelected =
    docs.some((doc) => selectedKeys.has(doc.diKey)) && !allSelected;
  ...
  const startPacking = async () => {
    ...
    try {
      ...
      logStartPacking('startSession:done', {
        ...
        navigateTo: '/(tabs)/packing/scan',
      });
      router.push('/(tabs)/packing/scan');
    } catch (error) {
